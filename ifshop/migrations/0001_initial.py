# Generated by Django 5.1.3 on 2024-12-17 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='camisetas', to=settings.AUTH_USER_MODEL)),
                ('cores', models.ManyToManyField(to='ifshop.cor')),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
