    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cursos', models.CharField(choices=[('infoweb', 'InfoWeb'), ('edific', 'Edific'), ('mamb', 'Mamb'), ('outros', 'Outros')], max_length=20, verbose_name='Curso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cores', models.ManyToManyField(blank=True, to='ifshop.cor')),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
